...
<!-- {% endif %} -->
  ...
  <div class="" align="center">
      <h1 class="heading">Panchayats Complaints Information</h1>
    </div>
...
<TABLE class="table table-bordered">
            ...
            ResultSet resultset =statement.executeQuery("select * from complaints where status='Waiting' and Gram_Panchayat_Email='"+Gram_Panchayat_Email+"'") ; 
           ...
           <TR>
              ...
              <TD> <%= resultset.getString(2) %> </TD>
               <TD> <%= resultset.getString(5) %> </TD>
                ...
                <td>
            <a href="accept?id=<%=resultset.getString(1)%>" style="background: yellow;color: black;">Accept</a> |
            <a href="reject?id=<%=resultset.getString(1)%>" style="background: yellow;color: black;">Reject</a> 
        </td>
