...
<!-- {% endif %} -->
  ...
  <div class="" align="center">
      <h1 class="heading">Panchayat Complaints Information</h1>
    </div>
 ...
 <%
      String id=request.getParameter("id");
                  ...
                  String email="",amount="",taxname="",desc="",duedate="";
                    ResultSet resultset =statement.executeQuery("select * from tax_notice where email_id='"+user_id+"' and id='"+id+"'") ; 
        			if(resultset.next())
                     {
        				email=resultset.getString(9);
        				amount=resultset.getString(6);
        				taxname=resultset.getString(4);
        				desc=resultset.getString(5);
        				duedate=resultset.getString(7);
                     }
        			
        			String pay=ConnectionFactory.tax_Amount_Payable(amount,duedate);
        			String[] data=pay.split("@");
         
      %>
<form class="form-light mt-20" action="tax_Paid"
								method="post">
								...
								<tr><td><br/></td></tr>
									...
									<tr>
										...
										<input type="text" class="form-control"
											name="gp_id" readonly="readonly" value="<%=id%>" required>
										</td>
									</tr>
								<tr><td><br/></td></tr>
								
									<tr>
										<td>Gram Panchayat Email</td>
										<td>
										<input type="text" class="form-control"
											name="gp_email" readonly="readonly" value="<%=email%>" required>
										</td>
									</tr>
									<tr><td><br/></td></tr>
									<tr>
										...
										<td>
										<input type="text" class="form-control"
											name="fund_name" readonly="readonly" value="<%=taxname%>" required>
										</td>
									</tr>
									<tr><td><br/></td></tr>
									...
									<tr>
										...
										<td><input type="text" class="form-control"
											name="gamount"  readonly="readonly" value="<%=amount%>" required></td>
									</tr>
									<tr><td><br/></td></tr>
									<tr>
										<td>Due Date</td>
										...
										<td><input type="text" class="form-control"
											name="fund_date"  readonly="readonly" value="<%=duedate%>" required></td>
									</tr>
									<tr><td><br/></td></tr>
									<tr>
										<td>Discount %</td>
										<td>
										<input type="text" class="form-control"
											name="Discount"  readonly="readonly" value="<%=data[2]%>" required>
										</td>
									</tr>
									<tr><td><br/></td></tr>
									<tr>
										...
										<td>
										<input type="text" class="form-control"
											name="Discount_Amount" readonly="readonly" value="<%=data[1]%>" required>
										</td>
									</tr>
									<tr><td><br/></td></tr>
									<tr>
										...
										<td><input type="text" class="form-control"
											name="Final_Amount" value="<%=data[0] %>" readonly="readonly" required></td>
									</tr>
<tr><td><br/></td></tr>
									<tr>
