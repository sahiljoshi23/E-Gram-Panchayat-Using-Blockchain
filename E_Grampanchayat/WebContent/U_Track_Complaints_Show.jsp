...
<!-- {% endif %} -->
 ...
 <%
      ...
      %>
<form class="form-light mt-20" action="ComplaintServlet"
								method="post">
								...
								<tr>
									...
									<tr>
										...
										<td><input type="text" class="form-control"
											name="fund_date"  value="<%=day.toString()%>" readonly="readonly" required></td>
									</tr>
<tr><td><br/></td></tr>
									<tr>
