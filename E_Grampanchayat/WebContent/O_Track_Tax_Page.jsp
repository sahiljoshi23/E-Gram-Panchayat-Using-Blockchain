...
<!-- {% endif %} -->
  ...
  <div class="" align="center">
      <h1 class="heading">Panchayat Tax Information</h1>
    </div>
...
<form class="form-light mt-20" action="tax_notice"
								method="post">
								...
								<tr>
									...
									<tr>
										...
										<input type="date" class="form-control"
											name="due_date" id="endDate" required></td>
									</tr>
<tr><td><br/></td></tr>
									<tr>
...
//Get today's date in yyyy-MM-dd format
  ...
  // Set minimum for end date to today's date
