...
<!-- {% endif %} -->
  ...
  <div class="" align="center">
      <h1 class="heading">Panchayats Tax Payment Show Information</h1>
    </div>
...
<div class="" align="center">
      <h1 class="heading">Panchayat Tax Payment Show Information</h1>
    </div>
<TABLE class="table table-bordered">
            ...
            ResultSet resultset =statement.executeQuery("select * from tax_notice where Gram_Panchayat_Email='"+Gram_Panchayat_Email+"'") ; 
